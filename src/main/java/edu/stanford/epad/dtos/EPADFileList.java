 ...
 * @author martin
 */
public class EPADFileList implements Serializable
{
	private static final long serialVersionUID = 1L;

	public final EPADFileResultSet ResultSet;

	public EPADFileList(List<EPADFile> Result)
	{
	...
	public static EPADFileList emptyImages()
	{
		return new EPADFileList();
	}
